...
#666 variables: lat, long, 7 environmental, 4 MEMS, 653 loci?
#14-373 are reference (=360 loci, does not match the paper)
...
## env_trns not found is it the same as envGF?
predRef <- predict(gfRef, envGF) # remove cell column before transforming
predGI5 <- predict(gfGI5, envGF)
