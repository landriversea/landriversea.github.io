...
TODO - more info on genetic data - lodgepole pine from accessions?
...
#coord.spatVect<- vect(Coordinates[,3:2], geom = c("Longitude", "Latitude"))
#Env<-terra::extract(ras_6190, coord.spatVect)
...
TODO - add in mems, show how to use pcoa with geographic distances
