...
1.   Identify important environmental variables for shaping genetic diversity ?

2.  Identify genetic loci that contributed to relevant phenotypes?

-   CF "We found a strongly negative relationship between genomic offset and seedling fitness in the common garden (Height: p-value = 1.2 e- 9 and R 2 = 0.12; Growth rate: p-value = 7.9 e-15and R 2= 0.19"

-   look at Moises Exposito
