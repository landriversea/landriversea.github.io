...
In this course, many analyses will be performed on a remote server. You will access the server in two ways, using Rstudio in your web browser, and through the command line using a terminal on your local machine.
